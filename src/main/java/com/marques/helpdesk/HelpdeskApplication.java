...
public class HelpdeskApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Tecnico tec1 = new Tecnico(null, "Marques Souza", "03589646101", "admin@admin.com","123");
		...
		Cliente cli2 = new Cliente(null, "Karol Soares", "15320786093", "karol@email.com","123");

		Cliente cli3 = new Cliente(null, "Geralda Soares", "41660905001", "geralda@email.com","123");

		Cliente cli4 = new Cliente(null, "Sara Soares", "84623724026", "sara@email.com","123");
